 ...
 */
appdatapreferences.DriveService.prototype.get = function(callback) {
  var that = this;
  this.discover_(function(err, file) {
 ...
 * @param  {Function=} opt_callback Optional callback.
 */
appdatapreferences.DriveService.prototype.create_ = function(opt_callback) {
  // TODO: create a file
 ...
 */
appdatapreferences.DriveService.prototype.discover_ = function(callback) {
  var that = this;
  if (this.fileId) {
    return this.get_(this.fileId, callback);
  }
  // TODO: fix query
  var query = { 'q': '"appdata" in parents and title contains "' + appdatapreferences.DriveService.FILE_NAME_  + '"' };
 ...
 */
appdatapreferences.DriveService.prototype.download_ =
